                ...
                <form action="{{ route('admin.user.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control form-control-solid @error('fullname') is-invalid @enderror"
                            id="fullname" name="fullname" value="{{ old('fullname') }}" required autocomplete="fullname"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control form-control-solid @error('email') is-invalid @enderror" id="email"
                            name="email" value="{{ old('email') }}" required autocomplete="email" type="email"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control form-control-solid @error('password') is-invalid @enderror" id="password" name="password" value="{{ old('password') }}" required autocomplete="password" type="text"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control form-control-solid @error('nomor_telpon') is-invalid @enderror"
                            id="nomor_telpon" name="nomor_telpon" value="{{ old('nomor_telpon') }}" required autocomplete="nomor"
