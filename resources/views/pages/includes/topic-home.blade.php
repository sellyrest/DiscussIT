...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <img style="height :60px; " src="{{$item->user->foto ? asset('img/profile/'.$item->user->foto) : asset('img/profile/default_fp.jpg') }}" alt="">
        ...
        <a href="/rspn" style="color: #C794B0; margin-left: 62%; margin-top: -50px">see all response</a>
    </div>
